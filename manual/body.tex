...
\label{nameslibsmods}
\todo{This is rubbish -- it might have been true a long time ago,
but modules no longer exist. However, the second paragraph
...
\todo{No idea if I can get this working with modules}

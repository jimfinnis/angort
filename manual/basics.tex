...
\footnotetext[2]{This is actually a call to the \texttt{range} function which takes two integers to create a range.}
\footnotetext[3]{Stored internally as an
